...
from create_benchmark import create_witness_graphs, ground_rule, corrupt_graph, rules
...
def create_sample(g, query, answer, witness_graphs, positive, completion_rules):
    ...
    return (sample_graph + witness_triples_for_answer) - dummy
...
def eval(g, query, bgp, answers,  aug, model_directory, summary_writer=None, threshold=0.5):
    ...
    for answer in answers:
        ...
        print('Metrics after ({0}/{1}) samples!'.format(counter, len(answers)))
